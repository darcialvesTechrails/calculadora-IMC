...
#-------------------Dividindo a janela do frame em duas partes--------------------
...
l_resultado.place(x=173, y=10)

l_resultado_text = Label(frame_baixo, text='', width=37, height=1, padx=6, pady=12, relief='flat', anchor='center', font=('Ivy 10 bold '), bg=co0, fg=co1)
l_resultado_text.place(x=0, y=87)
